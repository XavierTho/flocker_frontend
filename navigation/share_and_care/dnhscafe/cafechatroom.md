    ...
    <div class="form-container">
        ...
        <form id="postForm">
            ...
            <select id="group_id" name="group_id" required>
                ...
                <option value="">Math: :notebook::chart_with_upwards_trend:</option>
                <option value="">Chemistry: :female-scientist::skin-tone-2::test_tube:</option>
                <option value="">Biology: :dna::microscope:</option>
                <option value="">English: :apple::memo:</option>
            </select>
